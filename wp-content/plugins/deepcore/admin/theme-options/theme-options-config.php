<?php
    ...
    function webnus_redux_admin_css() {
        ...
        if ( ! is_customize_preview() ) {            
            wp_enqueue_style( 'wn-redux-admin-css', DEEP_CORE_URL . 'admin/theme-options/assets/wn-redux-admin.css' );
        } else {
            wp_enqueue_style( 'wn-redux-customizer', DEEP_CORE_URL . 'admin/theme-options/assets/wn-redux-customizer.css' );
        }
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'            => array(
            ...
            array(
                'title'     => esc_html__( 'CSS Minifier', 'deep' ),
                'subtitle'  => esc_html__( 'Enable this option to minify your styles. It\'ll decrease size of theme style-sheet files to speed up your website.', 'deep' ),
                'id'        => 'deep_minifier',
                'type'      => 'switch',
                'default'   => '1',
                'on'        => esc_html__( 'Enabled', 'deep' ),
