...
function whb_social( $atts, $uniqid, $once_run_flag ) {
	...
	if ( $once_run_flag ) :
        ...
        $dynamic_style .= whb_styling_tab_output( $atts, 'Slide type Icon/Text', 'body #wrap #webnus-header-builder [data-id=whb-social-' . esc_attr( $uniqid ) . ']  .wn-header-social-icon i:before,body #wrap #webnus-header-builder [data-id=whb-social-' . esc_attr( $uniqid ) . '] .wn-header-social-icon span', 'body #wrap #webnus-header-builder [data-id=whb-social-' . esc_attr( $uniqid ) . ']:hover .wn-header-social-icon i:before,body #wrap #webnus-header-builder [data-id=whb-social-' . esc_attr( $uniqid ) . ']:hover  .wn-header-social-icon span'  );

		$dynamic_style .= whb_styling_tab_output( $atts, 'Box', 'body #wrap #webnus-header-builder [data-id=whb-social-' . esc_attr( $uniqid ). ']' );
