    ...
    final class Webnus_Elementor_Extentions {
        ...
        public function init() {
            ...
            add_action( 'elementor/frontend/after_register_scripts', function() {
                wp_register_script( 'jquery-flipclock',         DEEP_ASSETS_URL . 'js/libraries/jquery.flipclock.js',           [ 'jquery' ], false, true );
                wp_register_script( 'countdown',                DEEP_ASSETS_URL . 'js/frontend/countdown.js',                   [ 'jquery' ], false, true );
                wp_register_script( 'process-carousel',         DEEP_ASSETS_URL . 'js/frontend/process-carousel.js',            [ 'jquery' ], false, true );
                wp_register_script( 'wn-svg',                   DEEP_ASSETS_URL . 'js/frontend/svg.js',                         [ 'jquery' ], false, true );
                wp_register_script( 'wn-news-ticker',           DEEP_ASSETS_URL . 'js/libraries/jquery.ticker.js',              [ 'jquery' ], false, true );
                wp_register_script( 'wn-google-map-js',         DEEP_ASSETS_URL . 'js/frontend/wn-google-map.js',               [ 'jquery' ], false, true );
                wp_register_script( 'latest-from-blog',         DEEP_ASSETS_URL . 'js/frontend/latestfromblog.js',              [ 'jquery' ], false, true );
                wp_register_script( 'wn-image-carousel',        DEEP_ASSETS_URL . 'js/frontend/image-carousel.js',              [ 'jquery' ], false, true );
                wp_register_script( 'jquery-twentytwenty',      DEEP_ASSETS_URL . 'js/libraries/jquery.twentytwenty.js',        [ 'jquery' ], false, true );
                wp_register_script( 'deep-owl-thumb',           DEEP_ASSETS_URL . 'js/libraries/owl.carousel2.thumbs.min.js',   [ 'jquery' ], false, true );
                wp_register_script( 'beforeafter',              DEEP_ASSETS_URL . 'js/frontend/beforeafter.js',                 [ 'jquery' ], false, true );
                wp_register_script( 'wnblog',                   DEEP_ASSETS_URL . 'js/frontend/blog.js',                        [ 'jquery' ], false, true );
                wp_register_script( 'wn-video-ply-btn',         DEEP_ASSETS_URL . 'js/frontend/video-ply-btn.js',               [ 'jquery' ], false, true );
                wp_register_script( 'info-box',                 DEEP_ASSETS_URL . 'js/frontend/info-box.js',                    [ 'jquery' ], false, true );
                wp_register_script( 'wn-lvs',                   DEEP_ASSETS_URL . 'js/frontend/wn-like.js',                     [ 'jquery' ], false, true );
                wp_register_script( 'postslider',               DEEP_ASSETS_URL . 'js/frontend/postslider.js',                  [ 'jquery' ], false, true );
                wp_register_script( 'wn-reservation',           DEEP_ASSETS_URL . 'js/frontend/reservation.js',                 [ 'jquery' ], false, true );
                wp_register_script( 'portfolio-carousel',       DEEP_ASSETS_URL . 'js/frontend/portfolio-carousel.js',          [ 'jquery' ], false, true );
                wp_register_script( 'testimonial-carousel',     DEEP_ASSETS_URL . 'js/frontend/testimonial-carousel.js',        [ 'jquery' ], false, true );
                wp_register_script( 'service-carousel',         DEEP_ASSETS_URL . 'js/frontend/service-carousel.js',            [ 'jquery' ], false, true );
                wp_register_script( 'our-team',                 DEEP_ASSETS_URL . 'js/frontend/our-team.js',                    [ 'jquery' ], false, true );
                wp_register_script( 'donate',                   DEEP_ASSETS_URL . 'js/frontend/donate.js',                      [ 'jquery' ], false, true );
                wp_register_script( 'sermon',                   DEEP_ASSETS_URL . 'js/frontend/sermon.js',                      [ 'jquery' ], false, true );
                wp_register_script( 'info-box',                 DEEP_ASSETS_URL . 'js/frontend/info-box.js',                    [ 'jquery' ], false, true );
                wp_register_script( 'wn-lvs',                   DEEP_ASSETS_URL . 'js/frontend/wn-like.js',                     [ 'jquery' ], false, true );
                wp_register_script( 'postslider',               DEEP_ASSETS_URL . 'js/frontend/postslider.js',                  [ 'jquery' ], false, true );
                wp_register_script( 'nw-short-socials',         DEEP_ASSETS_URL . 'js/frontend/socials.js',                     [ 'jquery' ], false, true );
                wp_register_script( 'nw-togglebox',             DEEP_ASSETS_URL . 'js/frontend/toggle-box.js',                  [ 'jquery' ], false, true );
                wp_register_script( 'wn-our-client',            DEEP_ASSETS_URL . 'js/frontend/our-clients.js',                 [ 'jquery' ], false, true );
                wp_register_script( 'wn-testimonial-slider',    DEEP_ASSETS_URL . 'js/frontend/testimonial-slider.js',          [ 'jquery' ], false, true );
                wp_register_script( 'wn-instagram',             DEEP_ASSETS_URL . 'js/frontend/instagram-carousel.js',          [ 'jquery' ], false, true );
                wp_register_script( 'wn-jquery-stats',          DEEP_ASSETS_URL . 'js/frontend/jquery.stats.min.js',            [ 'jquery' ], false, true );
                wp_register_script( 'cat-tab',                  DEEP_ASSETS_URL . 'js/frontend/cat-tab.js',                     [ 'jquery' ], false, true );
                wp_register_script( 'wn-magazine',              DEEP_ASSETS_URL . 'js/frontend/wn-magazine.js',                 [ 'jquery' ], false, true );
                wp_register_script( 'wn-content-carousel',      DEEP_ASSETS_URL . 'js/frontend/content-carousel.js',            [ 'jquery' ], false, true );
                wp_register_script( 'wn-content-slider',        DEEP_ASSETS_URL . 'js/frontend/content-slider.js',              [ 'jquery' ], false, true );
                wp_register_script( 'wn-testimonial-tabs',      DEEP_ASSETS_URL . 'js/frontend/wn-testimonial-tabs.js',         [ 'jquery' ], false, true );
                wp_register_script( 'widget-tabs',              DEEP_ASSETS_URL . 'js/frontend/widget-tabs.js',                 [ 'jquery' ], false, true );
                wp_register_script( 'wn-contact-form',          DEEP_ASSETS_URL . 'js/frontend/contact-form.js',                [ 'jquery' ], false, true );
                wp_register_script( 'title-builder',            DEEP_ASSETS_URL . 'js/frontend/title-builder.js',               [ 'jquery' ], false, true );
                wp_register_script( 'deep-facebook-app-id',     DEEP_ASSETS_URL . 'js/frontend/facebook-app.js',                [ 'jquery' ], false, true );
                wp_register_script( 'tab-content',              DEEP_ASSETS_URL . 'js/frontend/tab-content.js',                 [ 'jquery' ], false, true );
                wp_register_script( 'deep-gallery',             DEEP_ASSETS_URL . 'js/frontend/deep-gallery.js',                [ 'jquery' ], false, true );
                wp_register_script( 'deep-gallery-js',          DEEP_ASSETS_URL . 'js/libraries/lc.lightbox.min.js',            [ 'jquery' ], false, true );
                wp_register_script( 'wn-tilt-lib',              DEEP_ASSETS_URL . 'js/libraries/tilt.js',                       [ 'jquery' ], false, true );
                wp_register_script( 'wn-tilt',                  DEEP_ASSETS_URL . 'js/frontend/tilt.js',                        [ 'jquery' ], false, true );
                wp_register_script( 'food-menu',                DEEP_ASSETS_URL . 'js/frontend/food-menu.js',                   [ 'jquery' ], false, true );
            });
            ...
            add_action( 'elementor/editor/after_enqueue_styles', function() {
               ...
               $ui_theme = Elementor\Core\Settings\Manager::get_settings_managers( 'editorPreferences' )->get_model()->get_settings( 'ui_theme' );
                ...
                if ( 'dark' === $ui_theme ) {
                    wp_enqueue_style( 'wn-elementor-admin-dark', DEEP_ASSETS_URL . 'css/backend/elementor-dark-mode.css' );
                }
            });
        ...
        */
        public function deep_widget_styles() {
            ...
            wp_register_style( 'wn-deep-process-carousel', DEEP_ASSETS_URL . 'css/frontend/process-carousel/process-carousel.css' );
			...
			wp_register_style( 'wn-deep-category-tab', DEEP_ASSETS_URL . 'css/frontend/category-tab/category-tab.css' );
            ...
            wp_register_style( 'wn-deep-twentytwenty', DEEP_ASSETS_URL . 'css/frontend/twentytwenty/twentytwenty.css' );				
            wp_register_style( 'wn-deep-lvs', DEEP_ASSETS_URL . 'css/frontend/lvs/lvs.css' );				
            wp_register_style( 'wn-deep-blog', DEEP_ASSETS_URL . 'css/frontend/base/08-blog.css' );
        ...
        public function widgets_registered() {
            ...
            // Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Elementor\Webnus_Element_Widgets_Piecharts() );
        ...
        public function animation_pro_single_image_output( $content, $widget ) {
            ...
            if ( 'image' === $widget->get_name() ) {
                ...
                $data_id                = '#' . find_string($content, 'id="', '"' );
                        ...
                        $( document ).ready( function() {
                            ...
                            if (typeof attr !== typeof undefined && attr !== false) {
                                ...
                                new ScrollMagic.Scene({
                                    ...
                                    .setTween( scr_img , {  ' . $opacity . $rotation . $horizontal_movement . $vertical_movement . '  } )
                                    .addTo( controller );
                            }
                        }); // end document ready
                    })( jQuery );</script>';
                        ...
                        $( document ).ready( function() {
                            ...
                            if (typeof attr !== typeof undefined && attr !== false) {
                                ...
                                new ScrollMagic.Scene({
                                    ...
                                    .setTween( data_id , {  ' . $opacity . $rotation . $horizontal_movement . $vertical_movement . '  } )
                                    .addTo( controller );
                            }
                        }); // end document ready
                    })( jQuery );</script>';
