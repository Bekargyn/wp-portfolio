...
class WN_Content {
	...
	public function notfound_content() {
		...
		if ( $not_found_page_status && $not_found_page_id ) {
			wp_redirect(get_permalink($not_found_page_id));
		} else {
			?>
	...
	public function author_content() {
		...
		if ( defined( 'DEEP_HANDLE' ) ) {			
			include DEEP_DIR . 'templates/loops/blogloop-masonry.php';
		} else {
		...
		if ( $footer_show || is_archive() || is_single() || is_home() || is_search() || is_404() ) :
			...
			<section id="pre-footer">
				...
				if ( $footer_instagram_bar ) {					
					if ( defined( 'DEEP_HANDLE' ) ) {			
						include DEEP_DIR . 'templates/instagram-bar.php';
					} else {
				...
				if ( $footer_social_bar ) {					
					if ( defined( 'DEEP_HANDLE' ) ) {			
						include DEEP_DIR . 'templates/social-bar.php';
					} else {
				...
				if ( $footer_subscribe_bar ) {					
					if ( defined( 'DEEP_HANDLE' ) ) {			
						include DEEP_DIR . 'templates/subscribe-bar.php';
					} else {
					...
					if ( ! empty ( $footer_builder_page_id ) ) {
						...
						if ( ! empty ( $getFooterPost ) ) :
							...
							if ( $enable_footer_bottom ) {								
								if ( defined( 'DEEP_HANDLE' ) ) {			
									include DEEP_DIR . 'templates/footer-bottom.php';
								} else {
			...
			<section class="col-md-8">
				...
				if ( have_posts() ) :
					while( have_posts() ):
						the_post();						
						if ( defined( 'DEEP_HANDLE' ) ) {			
							include DEEP_DIR . 'templates/loops/blogloop-search.php';
						} else {
					...
					if ( defined( 'DEEP_HANDLE' ) ) {			
						include DEEP_DIR . 'templates/loops/blogloop-none.php';
					} else {
	...
	public function single_content() {
		...
		if ( $single_post_style == 'postshow1' ) {
			...
			if ( defined( 'DEEP_HANDLE' ) ) {			
				include DEEP_DIR . 'templates/loops/single/parts/post-show1.php';
			} else {
		...
		<section class="<?php echo esc_attr( $full_width ); ?>page-content">
			...
			<?php if ( $single_post_style == 'postshow3' ) { ?>
				...
				if ( defined( 'DEEP_HANDLE' ) ) {			
					include DEEP_DIR . 'templates/loops/single/parts/post-show3/post-thumbnail.php';
				} else {
				...
				if ( have_posts() ) :
					while ( have_posts() ) :
						...
						if ( $single_post_style == 'postshow1' ) {							
							...
							if ( defined( 'DEEP_HANDLE' ) ) {			
								include DEEP_DIR . 'templates/loops/single/postshow4.php';
							} else {
								get_template_part( 'inc/templates/loops/single/postshow4' );
							}
						} elseif ( $single_post_style == 'postshow5' ) {							
							if ( defined( 'DEEP_HANDLE' ) ) {			
								include DEEP_DIR . 'templates/loops/single/postshow5.php';
							} else {
								get_template_part( 'inc/templates/loops/single/postshow5' );
							}
						} else {							
							if ( defined( 'DEEP_HANDLE' ) ) {			
								include DEEP_DIR . 'templates/loops/single/postshow0.php';
							} else {
		...
		if ( is_plugin_active( 'jetpack/jetpack.php' ) ) :
			if ( deep_has_featured_posts( 1 ) ) :
				...
				if ( $this->post_count == '0' ) {
					...
					if ( defined( 'DEEP_HANDLE' ) ) {			
						include DEEP_DIR . 'templates/loops/blogloop.php';
					} else {
					...
					if ( defined( 'DEEP_HANDLE' ) ) {			
						include DEEP_DIR . 'templates/loops/blogloop-type2.php';
					} else {
	...
	private function default_grid() {
		if ( defined( 'DEEP_HANDLE' ) ) {			
			include DEEP_DIR . 'templates/loops/blogloop-type3.php';
		} else {
	...
	private function personal_blog_standard() {
		echo '<div class="blgtyp10 blg-personal-full">';
			if ( defined( 'DEEP_HANDLE' ) ) {			
				include DEEP_DIR . 'templates/loops/blogloop-type1.php';
			} else {
	...
	private function personal_blog_list() {
		echo '<div class="blg-personal-list">';
			if ( defined( 'DEEP_HANDLE' ) ) {			
				include DEEP_DIR . 'templates/loops/blogloop-type5.php';
			} else {
	...
	private function personal_blog_grid() {
		...
		echo '<div class="' . $cloumnsize . ' blg-typ3 blgtyp10 blg-personal-grid">';
			if ( defined( 'DEEP_HANDLE' ) ) {			
				include DEEP_DIR . 'templates/loops/blogloop-type7.php';
			} else {
	...
	private function magazine_standard() {
		...
		if ( $this->post_count == '0' ) {
			if ( defined( 'DEEP_HANDLE' ) ) {			
				include DEEP_DIR . 'templates/loops/blogloop-type6.php';
			} else {
	...
	private function magazine_list() {
		...
		echo '<div class="blgtyp11 blg-magazine-list">';
			if ( defined( 'DEEP_HANDLE' ) ) {			
				include DEEP_DIR . 'templates/loops/blogloop-type4.php';
			} else {
	...
	private function magazine_grid() {
		...
		echo '<div class="' . $cloumnsize . ' blg-magazine-grid">';
			echo '<div class="blgtyp11">';
				if ( defined( 'DEEP_HANDLE' ) ) {			
					include DEEP_DIR . 'templates/loops/blogloop-type8.php';
				} else {
	...
	private function minimal_standard() {
		...
		if ( $this->post_count == '0' ) {
			if ( defined( 'DEEP_HANDLE' ) ) {			
				include DEEP_DIR . 'templates/loops/blogloop-type9.php';
			} else {
