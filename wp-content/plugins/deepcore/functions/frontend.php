 ...
 * Deep Theme.
 *
 * Deep frontend handler class is responsible for initializing Deep in
 * the frontend.
 *
 * @since   1.0.0
 * @author  Webnus
...
if ( ! class_exists( 'WN_Frontend' ) ) {
    class WN_Frontend {
        ...
        public function register_scripts() {
			...
			// preloader
			wp_register_script( 'deep-preloader', DEEP_ASSETS_URL . 'js/libraries/preloader.js', array(), false, true );
			// Newsticker
        ...
        public function enqueue_styles() {
			...
			wp_register_style( 'deep-preloader',  DEEP_ASSETS_URL . 'css/libraries/preloader.css' );
        ...
        public function enqueue_preloader() {
			...
			wp_enqueue_style( 'deep-preloader' );
			wp_enqueue_script( 'deep-preloader' );
