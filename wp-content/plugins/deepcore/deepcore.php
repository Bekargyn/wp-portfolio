...
if ( $the_theme != 'deep-light' && $the_theme != 'deep-free' && $the_theme != 'deep' && $the_theme != 'deep-modern-business' ){
	return;
}

// Define directories
if ( $the_theme == 'deep-light' || $the_theme == 'deep' || $the_theme == 'deep-modern-business' ) {
	if ( ! defined( 'DEEP_DIR' ) ) {
...
define( 'DEEP_CORE_DIR', plugin_dir_path( __FILE__ ) );
define( 'DEEP_CORE_URL', plugin_dir_url( __FILE__ ) );
